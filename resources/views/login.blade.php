...
<head>
    ...
    <link rel="stylesheet" href="{{asset('apps/auth/style.css')}}">
...
<body>
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="{{asset('apps/auth/images/signin-image.jpg')}}" alt="sing up image"></figure>
    ...
    <script src="{{asset('apps/auth/vendor/jquery/jquery.min.js')}}"></script>
    <script src="{{asset('apps/auth/js/main.js')}}"></script>
</body>
</html>
